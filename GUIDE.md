# Voronoi Treemap — Template Guide

## What is a Voronoi Treemap?

A **Voronoi treemap** is a type of data visualization that uses Voronoi tessellation to display hierarchical data proportionally. Each polygon's area is proportional to the value it represents, making it easy to compare parts of a whole within a hierarchy.

### Voronoi Tessellation

A Voronoi tessellation divides a plane into regions based on distance to a set of seed points. In a Voronoi treemap, this technique is adapted so that regions (cells) have areas proportional to the data values, not just equal distances. The result is an organic, space-filling layout that avoids the rigid rectangular shapes of traditional treemaps.

### When to Use It

- Showing proportional part-to-whole relationships (e.g. market share, population distribution)
- Displaying one or two levels of hierarchy in a compact, visually engaging way
- When you want a more distinctive aesthetic than a standard bar chart or pie chart
